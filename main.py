...
# --- DATA STORAGE ---
items = {}            # {name: {"price": x, "f_id": x, "type": x, "text": x}}
sellable_types = {}   # {name: price} (এডমিন এগুলো /addsellable দিয়ে সেট করবেন)
user_balances = {}    
deposit_requests = {} 
pending_sells = {}    
...
def show_main_menu(chat_id):
    ...
    bot.send_message(chat_id, "স্বাগতম! নিচে আপনার কাঙ্ক্ষিত অপশন সিলেক্ট করুন:", reply_markup=markup)
...
def callback_handler(call):
    ...
    if action == "app":
        ...
        bot.send_message(uid, "✅ আপনার সেল রিকোয়েস্ট এপ্রুভ হয়েছে! আইটেমটি এখন শপে লাইভ।")
...
def bal(message): bot.send_message(message.chat.id, f"💰 আপনার বর্তমান ব্যালেন্স: {user_balances.get(message.chat.id, 0)} BDT")
